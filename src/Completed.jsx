...
function Completed(props) {
    ...
    useEffect(() => {
        ...
        async function getMultiple() {
            ...
            const snapshot = await notesRef.where('status', '==', 'complete').get();
            if (snapshot.empty) {
                return;
            }
    ...
    return (
        <><section className="main ">
            <div className="heading">Completed Items</div>
                                ...
                                <div className="note-card" key={index}>
                                    ...
                                    <div className="note-settings" style= {{display:showMenu?"block":"none"}}>
                                        <ul>
                                            ...
                                            }}><i className="fas fa-check-square"></i> Undone</li>
                                            ...
                                            <li onClick={()=>{
                                                ...
                                                notify("Please refresh to see update")
                                                setShowMenu(false)
                                            }}><i className="fas fa-trash"></i> To Trash</li>
